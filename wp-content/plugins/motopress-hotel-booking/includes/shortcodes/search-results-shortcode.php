...
class SearchResultsShortcode extends AbstractShortcode {
	...
	public function render( $atts, $content = '', $shortcodeName ){
		...
		} else if ( $atts['orderby'] == 'price' ) {
			$atts['orderby'] = 'post__in';
		} else if ( $atts['orderby'] == 'order' ) {
	...
	private function setupMatchedRoomTypes(){
		...
		$roomTypeDetailsList = array_filter( $roomTypeDetailsList, function( $roomTypeDetails ) use ( $checkInDate, $checkOutDate, $attributes ) {
